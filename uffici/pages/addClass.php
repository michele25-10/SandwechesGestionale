...
<body>
  ...
  <div class="container">
    <div class="row mt-5">
      <h2>Inserisci una nuova classe:</h2>
    </div>
    <div class="row mt-5">
      <table class="table table-striped">
        ...
        <tbody>
          <tr>
            ...
            <form method="post">
              <td>
                <input class="form-control" type="" id="name" placeholder="Anno" name="year"
                  maxlength="50" required>
                
              </td>
              <td>
                <input class="form-control" type="" id="name" placeholder="Sezione" name="section"
                  maxlength="50" required>
              </td>
              <td>
